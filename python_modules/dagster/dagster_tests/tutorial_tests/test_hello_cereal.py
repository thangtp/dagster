from dagster.tutorial.hello_cereal import hello_cereal_pipeline
...
def test_tutorial_intro_tutorial_hello_world():
    with pushd(script_relative_path('../../dagster/tutorial/')):
...
def test_tutorial_intro_tutorial_hello_world_cli():
    check_cli_execute_file_pipeline(
        script_relative_path('../../dagster/tutorial/hello_cereal.py'),
